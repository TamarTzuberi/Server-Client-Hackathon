...
class Server:
    ...
    def main(self):
        ...
        while 1:
            ...
            time.sleep(1)
            start_game()
            print("Game over!/nThecorrect answer was",self.answer,"!","/nCongratulations to the winner: " ,self.winner)
            reset_all()
        ...
        try:
            ...
            while(len(self.clients)<2):
                ...
                try:
                    ...
                    #print("add client")
                    self.clients.append((Thread(calc_self.question,(connection_socket,i)),client_name,addr,connection_socket))
                except:
                    print("error")
    ...
    def calc_question(self,connection_socket, client_num):
        message = "Welcome to Quick Maths./nPlayer 1: ",self.clients[0][1],"/nPlayer 2: ",self.clients[1][1],"/n==/nPlease self.answer the following self.question as fast as you can:"
